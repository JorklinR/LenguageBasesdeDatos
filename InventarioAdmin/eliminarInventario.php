...
<body>
    ...
    <form action="acciones/eliminarProducto.php" method="post">
...
if ($resultado->num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        <input type="text" name="desc" id="desc" readonly onmousedown="return false;"  placeholder="Digite la descripcion del producto" value="' . $row['descripcion'] . '">
    </div>
    
    <div>
        <label id="titulo2" for="precio">Precio:</label>
        <input type="text" name="precio" id="precio" readonly onmousedown="return false;" placeholder="Digite el precio" value="' . $row["precio"] . '">
    </div>
    
    <div>
        <label id="titulo2" for="telefono">Imagen:</label>
        <input type="text" name="imagen" id="imagen" readonly onmousedown="return false;" placeholder="Digite la url de la imagen" value="' . $row['imagen'] . '">
    </div>
